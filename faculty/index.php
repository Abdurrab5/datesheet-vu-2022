...
<body  >
    ...
    $query="SELECT * FROM faculty WHERE username='$aid' and password='$password' ";
    $result= mysqli_query($link, $query);
    if(mysqli_num_rows($result)){
        $row= mysqli_fetch_array($result);
       $_SESSION['faculty_id']=$row['faculty_id']; 
        $_SESSION['faculty']=$row['username']; 
...
<div  >
	<div>
		<h3 class="container"></h3><h3 style="color:lightblue">Faculty Login</h3>
	</div>
